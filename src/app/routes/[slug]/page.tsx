                ...
                <div className="h-full flex flex-col rounded-2xl border border-border bg-bg-secondary">
                  ...
                  <div className="shrink-0 p-6 pt-4 space-y-3 border-t border-border">
                    ...
                    <a
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-full border border-green py-3 text-sm font-semibold text-green hover:bg-green hover:text-white transition-colors"
                    >
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 lg:hidden border-t border-border bg-bg-secondary/95 backdrop-blur-md px-4 py-3 safe-bottom">
        <div className="flex items-center gap-3 max-w-lg mx-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-green text-green hover:bg-green hover:text-white transition-colors"
          >
          ...
          <a
            href={`tel:${contacts.phone_raw || "+79991234567"}`}
            className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-accent text-accent hover:bg-accent hover:text-bg-primary transition-colors"
          >
