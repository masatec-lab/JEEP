          ...
          <div className="relative z-10">
            ...
            <div className="mt-10 flex flex-col items-center gap-4">
              ...
              <div className="flex gap-3">
                {/* WhatsApp */}
                <a
                  href={contacts.whatsapp || "https://wa.me/79604374670"}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 rounded-full border border-green px-6 py-3 text-sm font-semibold text-green hover:bg-green hover:text-white transition-all"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 rounded-full border border-[#2AABEE] px-6 py-3 text-sm font-semibold text-[#2AABEE] hover:bg-[#2AABEE] hover:text-white transition-all"
                >
                  <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 rounded-full border border-[#FF6600] px-6 py-3 text-sm font-semibold text-[#FF6600] hover:bg-[#FF6600] hover:text-white transition-all"
                >
            ...
            <p className="mt-8 text-sm text-text-muted">
              Или позвоните:{" "}
              <a
                href={`tel:${contacts.phone_raw || "+79604374670"}`}
                className="font-semibold text-accent hover:text-accent-hover transition-colors"
              >
                {contacts.phone || "+7 (960) 437-46-70"}
              </a>
            </p>
          </div>
        </div>
